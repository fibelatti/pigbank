...
class UserPreferencesMapper @Inject constructor() {
    fun toDomainModel(userPreferencesDataModelList: List<UserPreferencesDataModel>): UserPreferencesEntity = with(userPreferencesDataModelList) {
        ...
        return@with UserPreferencesEntity(
