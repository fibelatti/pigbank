...
class DecimalDigitsInputFilter(
    digitsBeforeZero: Int = DIGITS_BEFORE_ZERO,
    digitsAfterZero: Int = DIGITS_AFTER_ZERO
) : InputFilter {
    private val pattern: Pattern = """[0-9]{0,${digitsBeforeZero - 1}}(?:[\.,][0-9]{0,${digitsAfterZero - 1}})?""".toPattern()
